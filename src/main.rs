...
const CHARACTERS: [char; 16] = [
    ' ', '\'', '`', '-', '.', '|', '/', '/', ',', '\\', '|', '\\', '_', '\\', '/', '#',
];
const GRAVITY: f64 = 1.0;
const PRESSURE: f64 = 4.0;
const VISCOSITY: f64 = 7.0;
...
static mut PARTICLES: [Particle; CONSOLE_WIDTH * CONSOLE_HEIGHT * 2] = [Particle {
    x_pos: 0.0,
    y_pos: 0.0,
    density: 0.0,
    wallflag: 0,
...
static mut SCREEN_BUFFER: [u8; CONSOLE_WIDTH * CONSOLE_HEIGHT + 1] =
...
fn main() {
    ...
    loop {
        // let mut x_particle_distance: f64 = 0.0;
        // let mut y_particle_distance: f64 = 0.0;
        // let mut particles_interaction: f64 = 0.0;
        // let mut particles_distance: f64 = 0.0;
