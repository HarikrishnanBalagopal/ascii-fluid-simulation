use crate::constants::{
    ScreenBuffer, CHARACTERS, CONSOLE_HEIGHT, CONSOLE_WIDTH, GRAVITY, PARTICLES, PRESSURE,
    SCREEN_BUFFER, VISCOSITY,
};
...
pub fn initialize(level_file_data: Vec<u8>) -> usize {
...
#[no_mangle]
pub extern "C" fn step_global(total_of_particles: usize) {
    ...
    for particles_cursor in 0..total_of_particles {
        ...
        unsafe {
            PARTICLES[particles_cursor].density = (PARTICLES[particles_cursor].wallflag * 9) as f64;
        }
    ...
    for particles_cursor in 0..total_of_particles {
        ...
        unsafe {
            ...
            if y >= 0 && y < (CONSOLE_HEIGHT - 1) as i32 && x >= 0 && x < (CONSOLE_WIDTH - 1) as i32
            {
...
#[no_mangle]
pub extern "C" fn get_address_global() -> *const ScreenBuffer {
